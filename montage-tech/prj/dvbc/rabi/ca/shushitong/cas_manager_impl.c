...
extern void ui_close_finger_mainwin(void);
extern void ui_finger_print_repaint(void);
extern BOOL ui_finger_is_repaint(void);
...
static menu_attr_t shushitong_ca_menu_attr[] =
{
  ...
  {ROOT_ID_EMAIL_MESS, PS_STOP, OFF, SM_OFF, open_email_mess_DIVI},
...
{
  //  root_id,						  play_state,	auto_close, signal_msg,   open
  {ROOT_ID_EMAIL_MESS,		  PS_KEEP, OFF, SM_OFF, open_email_mess_MG},
  {ROOT_ID_CA_CARD_INFO,	  PS_KEEP, OFF, SM_OFF, open_ca_card_info},
