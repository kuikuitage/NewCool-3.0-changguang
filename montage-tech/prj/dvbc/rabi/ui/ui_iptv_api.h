...
typedef enum
{
	IPTV_API_FORMAT_NORMAL 		= TYPE_VD_300,
	IPTV_API_FORMAT_HIGH 			= TYPE_VD_600,
	IPTV_API_FORMAT_SUPER 		= TYPE_VD_1000,
	IPTV_API_FORMAT_TOPSPEED 	= TYPE_VD_FAST,
	IPTV_API_FORMAT_720P 			= TYPE_VD_720P,
	IPTV_API_FORMAT_1080P 		= TYPE_VD_1080P ,
	IPTV_API_FORMAT_DEFAULT 		= TYPE_VD_600,
}IPTV_API_FORMAT_T;
